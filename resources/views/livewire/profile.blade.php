<div>
    ...
    <div class="md:flex">
        <div class="grid grid-cols-1  mt-4 gap-4 md:w-1/4 sm:mx-5 md:h-1/4">
            <div class="bg-white p-4 rounded-lg shadow ">
                <div class="">
                    <div class="rounded-lg shadow-xl flex justify-center"><img class="object-contain ml-4 p-4" src="storage/{{ $user->profpix }}"  alt="product image"></div>
                    ...
                    <div class="sm:block space-y-5">
                       ...
                       <div class=" font-medium text-black">{{ $user->occupation}}</div>
        ...
        <div class="bg-white p-5 rounded-lg shadow md:mt-5 md:mr-5 md:mx-auto md:w-3/4">
           <div class="md:grid md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <x-input wire:model.lazy="firstname" id="firstname" name="firstname" type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none"> </x-input>
                ...
                <div>
                    ...
                    <x-input wire:model.lazy="lastname" id="lastname" type="text"  class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none"> </x-input>
           ...
           <div class="form-group">
            <x-label class="mt-2 font-bold" for="profpix" :value="__('Upload Profile Pix')"></x-label>
                    <x-input wire:model.lazy="profpix" id="profpix" name="profpix" type="file" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none"> </x-input>
           ...
           <div class="form-group">
            <x-label class="mt-2 font-bold" for="about" :value="__('Tell Us About YourSelf')"></x-label>
                    <textarea wire:model.lazy="about" cols="10" rows="8" id="about" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none"> </textarea>
           ...
           <div class="md:grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <x-input wire:model.lazy="phone" id="phone" name="phone" type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none"> </x-input>
                @error('phone') <span class="text-red-600 text-sm">{{ $message }} </span> @enderror
            </div>
            <div>
                <x-label class="mt-2 font-bold" for="lastname" :value="__('Language')"></x-label>
                <x-input wire:model.lazy="language" id="language" type="text"  class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none"> </x-input>
       ...
       <div class="md:grid md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <x-input wire:model.lazy="occupation" id="occupation" name="occupation" type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-gray-100 bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none"> </x-input>
    ...
    <div class="buttons m-5 px-4">
        <button wire:click="update" type="submit" class="btn-outline-reg">Update</button>
    </div>
